...
def get_direction(
        wd):  # convert from deg to compass direction used javascript @ http://www.csgnetwork.com/degrees2direct.html as a skeliton
...
def get_info(verbose, city, country, unit):
    try:
        ...
        print_info(city_json, country_json, description, temp, max_temp, min_temp, str(wind_speed), wind_dir, myArr,
                   temp_unit, speed_unit)
